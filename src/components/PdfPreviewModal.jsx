            ...
            {isOpen && (
                <Dialog open={isOpen} onOpenChange={onClose}>
                    <DialogContent
                        ...
                        className="bg-[#1e1e22] border-neutral-700 text-white !p-1 rounded-2xl shadow-[0_0_10px_rgba(233,30,99,0.5)] 
                    ...
                    >
                        ...
                        <DialogFooter className="!p-2 flex-row justify-end gap-3 flex-shrink-0 border-t border-neutral-700">
                            <Button
                                variant="outline"
                                onClick={onClose}
                                className="!px-2 bg-neutral-700 border-neutral-600 hover:bg-neutral-600 text-gray-200"
                            >
                                Cancel
                            </Button>
                            <Button
